            ...
            <v-row class="mb-4">
              <v-col cols="12" sm="8">
                <v-list-item three-line>
                  <v-list-item-content>
                    <div class="mb-4">
                      <v-btn fab color="cyan lighten-2 float-right" elevation="0">
            ...
            <v-row class="mb-4">
              <v-col cols="12" sm="8">
                <v-list-item three-line>
                  <v-list-item-content>
                    <div class="mb-4">
                      <v-btn fab color="pink lighten-2 float-right" elevation="0">
            ...
            <v-row class="mb-4">
              <v-col cols="12" sm="8">
                <v-list-item three-line>
                  <v-list-item-content>
                    <div class="mb-4">
                      <v-btn fab color="orange lighten-2 float-right" elevation="0">
                    ...
                    <v-list-item-subtitle class="white--text">Videos</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
              </v-col>
              <v-col cols="12" sm="4">
